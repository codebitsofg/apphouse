    ...
    <TermsContainer>
      <ContentWrapper>
        ...
        <Section>
          ...
          <Paragraph>
            Welcome to our mobile applications and services (the
            &ldquo;Apps&rdquo;). These Terms and Conditions
            (&ldquo;Terms&rdquo;) govern your access to and use of our Service,
            including (i) our mobile applications, (ii) any related websites and
        ...
        <Section>
          <SectionTitle>3. Use License</SectionTitle>
          <Paragraph>
            Permission is granted to download and use our applications for
        ...
        <Section>
          <SectionTitle>4. Content and Accuracy</SectionTitle>
          <Paragraph>
            While we strive for accuracy, we make no warranties about the
            completeness or accuracy of the content provided through our
            applications. Users should verify any information with authoritative
        ...
        <Section>
          ...
          <Paragraph>As a user of our applications, you agree to:</Paragraph>
          <List>
            <ListItem>Use the app only for legitimate purposes</ListItem>
            <ListItem>
        ...
        <Section>
          ...
          <Paragraph>
            ...
            information. By using our applications, you consent to the
            collection and use of information as described in our Privacy
            Policy.
          </Paragraph>
        </Section>

        <Section>
          <SectionTitle>7. App Availability</SectionTitle>
          <Paragraph>
            We strive to keep our applications available and functioning
            properly, but we do not guarantee uninterrupted access. The apps may
            be temporarily unavailable due to maintenance, updates, or technical
        ...
        <Section>
          ...
          <Paragraph>
            ...
            continuing to use our applications after changes are made, you are
        ...
        <Section>
          ...
          <Paragraph>
            ...
            <Highlight>BubbleApp Studio</Highlight> and is protected by
        ...
        <Section>
          ...
          <Paragraph>
            In no event shall BubbleApp Studio or its developers be liable for
