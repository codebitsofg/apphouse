    ...
    <PrivacyContainer>
      <ContentWrapper>
        ...
        <Section>
          ...
          <Paragraph>
            Welcome to our mobile applications and services (&ldquo;we,&rdquo;
            ...
            (&ldquo;Apps&rdquo;). By using our Apps, you consent to the
        ...
        <Section>
          ...
          <Paragraph>
            Our applications are published by BubbleApp Studio and are designed
            for users worldwide. We comply with relevant data protection
        ...
        <Section>
          ...
          <List>
            ...
            <ListItem>
              <strong>User Data:</strong> To provide personalized experiences
              and track your usage (e.g., preferences, progress, settings), we
              store this data under your account.
            </ListItem>
          </List>
        ...
        <Section>
          ...
          <List>
            ...
            <ListItem>
              <strong>Account Sync:</strong> Synchronize your data and
              preferences across devices if you create an account.
            </ListItem>
            <ListItem>
              <strong>Subscription Management:</strong> Process payments and
              manage premium features of our applications.
            </ListItem>
            <ListItem>
              ...
              third-party ads within our applications.
            </ListItem>
          </List>
        </Section>
        ...
        <Section>
          ...
          <List>
            ...
            <ListItem>
              ...
              emailing us at info@bubbleappstudio.com or through the app&rsquo;s
        ...
        <Section>
          ...
          <Paragraph>
            Our applications are designed for users aged 16 and above and are
            not intended for individuals under the age of 16. We do not
            ...
            at info@bubbleappstudio.com, and we will promptly take steps to
            delete it.
          </Paragraph>
        </Section>
        ...
        <ContactInfo>
          ...
          <Paragraph>
            <strong>
              By using our applications, you acknowledge that you have read and
